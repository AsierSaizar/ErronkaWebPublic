    ...
    <div class="container">
        ...
        <div class="formularioa">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "INSERT INTO hornitzaileak (EmpresarekoTlfZenbakia, EmpresarenIzena, EmpresarenKorreoa, Helbidea, NAN) VALUES (?, ?, ?, ?, ?)";

                $stmt = $conn->prepare($sql);
                $stmt->bind_param("sssss", $tlfzenb, $empresaizena, $korreoa, $empresahel, $nan);
